        ...
        <div class="col-12 bg-white border rounded p-4 mt-4 shadow-sm">
            ...
            ?>
                ...
                <div class="form-floating mt-1 col-6">
                    <img src="assets/images/profile/<?=$user['profile_picture']?>" class="img-thumbnail my-3" style="height:150px;" alt="...">
                    <div class="mb-3">
                ...
                <div class="d-flex gap-3 my-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3"
                            value="option3" <?=$user['gender']==3?'checked': ''?>disabled>
